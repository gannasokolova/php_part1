...
<p><?php include_once '26.php' ?></p>
<p>27. Выполните скрипт по задаче №4 из консоли (необходимо запустить php скрипт по задаче №4 из командной строки).</p>
<p> Для запуска в консоли выполнить: C:\OpenServer\domains\localhost\homework\php_start\php_basics_tasks\1.php </p>
<hr>
